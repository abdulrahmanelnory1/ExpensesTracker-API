...
namespace ExpensesTracker.Migrations
{
    ...
    [Migration("20250919185352_CreateRegularExpense")]
    partial class CreateRegularExpense
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExpensesTracker.Models.RegularExpense", b =>
                {
            ...
            modelBuilder.Entity("ExpensesTracker.Models.RegularExpense", b =>
                {
                    b.HasOne("ExpensesTracker.Models.Expense", null)
                        .WithOne()
                        .HasForeignKey("ExpensesTracker.Models.RegularExpense", "ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
